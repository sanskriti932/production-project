...
<div class="py-5">
    <div class="container">
                ...
                <div class="card relative">
                    ...
                    <div class="card-body flex flex-col justify-between">
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            @if($item->cafeproducts->qty >= $item->cafeprod_qty)
        ...
        <div class="flex flex-col items-center justify-center py-12">
            ...
            <a href="{{url('cafecategory')}}"><button class="px-6 py-2  bg-[#b3ab78] text-white rounded-md shadow-md hover: transition-colors duration-300">
                    Let's go shopping!
                </button>
            </a>
        </div>
