<nav class="text-white text-base font-semibold pt-3">
    ...
    <a href="{{ url('add-cafecategory') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item {{ Request::is('add-cafecategory') ? 'active-nav-link' : '' }}">
