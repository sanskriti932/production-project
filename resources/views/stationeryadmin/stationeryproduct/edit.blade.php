...
<div class="card">
    <div class="card-header">
        <h4 class="text-lg font-semibold">Edit Stationery Product</h4>
    </div>
    <div class="card-body">
        <form action="{{ url('update-stationeryproduct/'.$products->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-span-2">
                <select class="form-select">
                    <option value="">{{$products->stationerycategory->name}}</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="checkbox" id="popular" name="popular" {{ $products->trending == "1" ? 'checked' : '' }} class="form-checkbox mt-1">
                </div>
                <div class="col-span-2">
