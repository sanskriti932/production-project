...
<div class="card">
    <div class="card-header">
        <h4 class="text-lg font-semibold">Add Cafe Product</h4>
    </div>
    <div class="card-body">
        <form action="{{ url('insert-cafeproduct') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-span-2">
                <select class="form-select" name="cafecate_id">
                    <option value="">Select a Cafe Category</option>
